...
int main() {
	...
	//shell sort4 (Unsure if interval is correct but still sorts)
	...
	for(i=0; i<MAX; i++){
                ...
                printf("Sorted Array2[%d] %d\n",i,array2[i]);
        }for(i=0; i<MAX; i++){
                printf("Sorted Array3[%d] %d\n",i,array3[i]);
        }for(i=0; i<MAX; i++){
                printf("Sorted Array4[%d] %d\n",i,array4[i]);
        }
	for(i=0; i<MAX; i++){
		printf("Sorted Array5[%d] %d\n",i,array5[i]);
	}
